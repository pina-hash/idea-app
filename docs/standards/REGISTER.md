...
| `IDEA_REPO_WORKFLOW_STANDARD.md` | 1.1 | 2026-09-02 | One development workflow across `idea-app`, `fll-app` and `frc-app`: `idea-app` as the reference, what every repo carries (`CLAUDE.md` sections, the three workflows, `docs/history`, ledger, decisions, status tool, harnesses, tests, numbered migrations), what differs on purpose, and the dated conformance table |
