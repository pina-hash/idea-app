...
- Ledger entry: `docs/prompt-ledger/entries/0138-html-assignment-write-gate.md`
- `Migration permitted: exactly one. (The entry puts `Claims: 0197.` on its own bullet, not folded into this line -- see the note.)`
- Written on `claude/html-assignment-ledger-0138-9third`.
...
- object function public._classroom_html_manifest
