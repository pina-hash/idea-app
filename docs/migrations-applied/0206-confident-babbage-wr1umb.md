...
- Ledger entry: `docs/prompt-ledger/entries/0181-ideacad-guard-supersede-0202.md`
- `Migration permitted: exactly one. Claims: 0206. Highest on origin/main at issue: 0203`
- Written on `claude/confident-babbage-wr1umb`.
