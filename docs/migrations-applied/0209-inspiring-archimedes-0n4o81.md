...
- Ledger entry: `docs/prompt-ledger/entries/0189-ideacad-durable-action-history.md`
- `Migration permitted: exactly one. Claims: 0209.`
- Written on `claude/inspiring-archimedes-0n4o81`.
...
0209_ideacad_history.sql. Reported result:

  nine rows, all true
  the concept count equals the origin-row count
