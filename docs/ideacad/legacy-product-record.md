# Legacy IdeaCAD product record

This is the product record before the 2026-09-15 direct-modeler implementation. Its implementation descriptions and limitations are historical. Current behavior is in [IDEACAD.md](../IDEACAD.md).
