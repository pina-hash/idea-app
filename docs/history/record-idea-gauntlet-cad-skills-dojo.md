---
title: "IDEA // GAUNTLET (CAD skills dojo)"
date: 2026-06-29
branches: []
migrations: ["0004", "0005", "0006", "0007", "0008", "0009", "0010", "0011", "0012", "0013", "0015", "0016", "0017", "0018", "0019", "0021", "0022", "0023", "0024", "0025", "0026", "0027", "0028", "0029", "0030", "0033", "0034", "0035", "0036", "0059", "0060", "0061"]
subsystems: ["GAUNTLET"]
record_order: 20
---
  ...
  - **Interactive drawing viewer (rebuilt on the PDF contract).**
    ...
    **full-sheet PDF** rendered with pdf.js (`pdfjs-dist`, loaded lazily and
    ...
    - **One shared transform.** The rendered sheets AND the region hotspots live
      ...
      position the overlay layer independently of the drawing. **The
      transform itself lives in `$lib/panzoom` now** -- see "The pan/zoom
      engine is shared" below; this component owns the state it writes into
