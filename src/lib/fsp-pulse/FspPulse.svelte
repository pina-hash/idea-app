<script lang="ts">
	...
	const save = new SaveState({
		...
		onHide: () => flushBeacon(),
		fallbackMessage: 'Could not save your answers. Tap Retry, or just leave this page open.',
		async save() {
			...
			try {
				...
				return {
					ok: false,
					retryable: true,
					message: 'Could not save your answers. Tap Retry, or just leave this page open.'
				} as const;
			}
		}
	});
