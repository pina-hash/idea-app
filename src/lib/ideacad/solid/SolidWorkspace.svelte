...
<style>
	/* The report control floats over the footer's tool name at every width, and over the tool bar on a phone. */
	:global(body:has(.solid-workspace) .sfb-shell){bottom:40px}
