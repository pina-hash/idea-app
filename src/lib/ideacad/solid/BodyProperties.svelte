...
<style>
	section{border-top:1px solid var(--boundary);margin-top:10px;padding-top:10px;display:grid;gap:10px}label{display:grid;gap:4px;font:600 15px Rajdhani,sans-serif;color:var(--text-2)}input,select{min-height:44px;width:100%;box-sizing:border-box;background:var(--surface-0);color:var(--text-1);border:1px solid var(--boundary);border-radius:4px;padding:0 8px;font:16px Rajdhani,sans-serif}output,a,small{font:15px Rajdhani,sans-serif;color:var(--text-2)}a{min-height:44px;display:flex;align-items:center;color:var(--cyan)}
	.appearance{display:grid;gap:8px;padding:8px;border:1px solid var(--boundary);border-radius:5px}.sentence{margin:0;display:flex;align-items:center;gap:8px;flex-wrap:wrap;font:600 15px Rajdhani,sans-serif;color:var(--text-1)}.own{color:var(--text-2);font-weight:500}
	.chip{display:inline-block;width:18px;height:18px;border-radius:50%;border:1px solid var(--boundary);flex-shrink:0}
	.swatches{display:grid;grid-template-columns:repeat(auto-fill,minmax(128px,1fr));gap:6px}.swatch{min-height:44px;display:flex;align-items:center;gap:8px;padding:0 10px;border:1px solid var(--boundary);border-radius:5px;background:var(--surface-0);color:var(--text-1);font:600 15px Rajdhani,sans-serif;cursor:pointer;text-align:left}.swatch:hover:not(:disabled){background:var(--surface-2)}.swatch:focus-visible{outline:2px solid var(--cyan);outline-offset:-2px}.swatch.current{border-color:var(--green);color:var(--green)}.swatch:disabled{opacity:.5;cursor:default}.word{flex:1}.mark{font:12px 'Share Tech Mono',monospace}
