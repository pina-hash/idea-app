...
<style>
	...
	.settings,.selection,.regions{display:grid;gap:6px;padding-top:6px;border-top:1px solid var(--boundary)}.selection p{margin:0;font-size:14px;color:var(--text-2)}
