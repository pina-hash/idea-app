...
const SFX = {
	...
	ui_confirm: { files: takes('sfx_ui_confirm', 2), bus: 'ui', gain: 0.4 },
	...
	ui_tab_switch: { files: takes('sfx_ui_tab_switch', 2), bus: 'ui', gain: 0.26, jitter: [0.98, 1.02] },
	ui_purchase: { files: takes('sfx_ui_purchase', 1), bus: 'ui', gain: 0.45 },
	ui_insufficient_funds: { files: takes('sfx_ui_insufficient_funds', 1), bus: 'ui', gain: 0.36 },
	...
	// ---- Weapons ----
	wpn_autocannon_fire: { files: takes('sfx_wpn_autocannon_fire', 5), bus: 'weapons', gain: 0.3, jitter: [0.94, 1.07] },
	...
	wpn_railgun_impact: { files: takes('sfx_wpn_railgun_impact', 3), bus: 'impacts', gain: 0.44 },
	wpn_shotgun_fire: { files: takes('sfx_wpn_shotgun_fire', 4), bus: 'weapons', gain: 0.36, jitter: [0.9, 1.1] },
	wpn_shotgun_impact: { files: takes('sfx_wpn_shotgun_impact', 3), bus: 'impacts', gain: 0.32, jitter: [0.9, 1.1] },
	...
	wpn_rocket_impact: { files: takes('sfx_wpn_rocket_impact', 3), bus: 'impacts', gain: 0.46 },
	wpn_cluster_launch: { files: takes('sfx_wpn_cluster_launch', 2), bus: 'weapons', gain: 0.4, jitter: [0.95, 1.05] },
	wpn_cluster_impact_direct: { files: takes('sfx_wpn_cluster_impact_direct', 2), bus: 'impacts', gain: 0.46 },
	wpn_cluster_impact_splash: { files: takes('sfx_wpn_cluster_impact_splash', 3), bus: 'impacts', gain: 0.3, jitter: [0.9, 1.12] },
	wpn_turret_fire: { files: takes('sfx_wpn_turret_fire', 5), bus: 'weapons', gain: 0.24, jitter: [0.93, 1.08] },
	wpn_turret_swivel: { files: takes('sfx_wpn_turret_swivel', 1), bus: 'weapons', gain: 0.16, jitter: [0.94, 1.06] },
	wpn_shield_activate: { files: takes('sfx_wpn_shield_activate', 1), bus: 'weapons', gain: 0.34 },
	wpn_shield_hum: { files: takes('sfx_wpn_shield_hum', 1), bus: 'weapons', loop: true, gain: 0.16, fadeIn: 0.12 },
	wpn_shield_break: { files: takes('sfx_wpn_shield_break', 1), bus: 'impacts', gain: 0.42 },
	wpn_jammer_hum: { files: takes('sfx_wpn_jammer_hum', 1), bus: 'weapons', loop: true, gain: 0.12, fadeIn: 0.2 },
	wpn_blades_deploy: { files: takes('sfx_wpn_blades_deploy', 1), bus: 'weapons', gain: 0.34 },
	wpn_blades_contact: { files: takes('sfx_wpn_blades_contact', 4), bus: 'impacts', gain: 0.32, jitter: [0.9, 1.12] },
	wpn_blades_retract: { files: takes('sfx_wpn_blades_retract', 1), bus: 'weapons', gain: 0.26 },
	wpn_caltrops_deploy: { files: takes('sfx_wpn_caltrops_deploy', 1), bus: 'weapons', gain: 0.32 },
	...
	wpn_oil_deploy: { files: takes('sfx_wpn_oil_deploy', 1), bus: 'weapons', gain: 0.32 },
	wpn_oil_trigger: { files: takes('sfx_wpn_oil_trigger', 3), bus: 'impacts', gain: 0.34, jitter: [0.92, 1.08] },
	wpn_hook_launch: { files: takes('sfx_wpn_hook_launch', 1), bus: 'weapons', gain: 0.34 },
	wpn_hook_latch: { files: takes('sfx_wpn_hook_latch', 1), bus: 'impacts', gain: 0.36 },
	wpn_hook_pull: { files: takes('sfx_wpn_hook_pull', 1), bus: 'weapons', loop: true, gain: 0.2, fadeIn: 0.1 },
	wpn_hook_release: { files: takes('sfx_wpn_hook_release', 1), bus: 'weapons', gain: 0.3 },

	// ---- Abilities ----
	abl_nitro_activate: { files: takes('sfx_abl_nitro_activate', 2), bus: 'weapons', gain: 0.38 },
	abl_nitro_loop: { files: takes('sfx_abl_nitro_loop', 1), bus: 'weapons', loop: true, gain: 0.26, fadeIn: 0.1 },
	abl_nitro_end: { files: takes('sfx_abl_nitro_end', 1), bus: 'weapons', gain: 0.28 },
	abl_jump: { files: takes('sfx_abl_jump', 2), bus: 'weapons', gain: 0.34, jitter: [0.95, 1.08] },
	abl_flip: { files: takes('sfx_abl_flip', 1), bus: 'weapons', gain: 0.36 },
	abl_repair_activate: { files: takes('sfx_abl_repair_activate', 1), bus: 'weapons', gain: 0.32 },
	abl_repair_loop: { files: takes('sfx_abl_repair_loop', 1), bus: 'weapons', loop: true, gain: 0.22, fadeIn: 0.1 },
	abl_repair_complete: { files: takes('sfx_abl_repair_complete', 1), bus: 'weapons', gain: 0.34 },
	abl_grip_activate: { files: takes('sfx_abl_grip_activate', 1), bus: 'weapons', gain: 0.3 },
	abl_grip_loop: { files: takes('sfx_abl_grip_loop', 1), bus: 'weapons', loop: true, gain: 0.2, fadeIn: 0.1 },
	...
	veh_hit_crunch: { files: takes('sfx_veh_hit_crunch', 4), bus: 'impacts', gain: 0.38, jitter: [0.9, 1.08] },
	veh_connector_snap: { files: takes('sfx_veh_connector_snap', 2), bus: 'impacts', gain: 0.34, jitter: [0.92, 1.1] },
	veh_armor_strip: { files: takes('sfx_veh_armor_strip', 2), bus: 'impacts', gain: 0.4, jitter: [0.94, 1.06] },
	veh_mount_kill: { files: takes('sfx_veh_mount_kill', 1), bus: 'impacts', gain: 0.46 },
	veh_low_health_warning: { files: takes('sfx_veh_low_health_warning', 1), bus: 'ambient', loop: true, gain: 0.22, fadeIn: 0.15 },
	veh_flip_recover: { files: takes('sfx_veh_flip_recover', 1), bus: 'ambient', gain: 0.38 },
	veh_offline_status: { files: takes('sfx_veh_offline_status', 1), bus: 'ambient', gain: 0.34 },

	// ---- Environment / track ----
	env_draft_engage: { files: takes('sfx_env_draft_engage', 1), bus: 'ambient', gain: 0.26 },
	env_boost_pad: { files: takes('sfx_env_boost_pad', 2), bus: 'ambient', gain: 0.4, jitter: [0.95, 1.06] },
	env_pit_repair_loop: { files: takes('sfx_env_pit_repair_loop', 1), bus: 'ambient', loop: true, gain: 0.28, fadeIn: 0.15 },
	env_ambient_yard: { files: takes('sfx_env_ambient_yard', 1), bus: 'ambient', loop: true, gain: 0.16, fadeIn: 1.2 },
	env_rain_loop: { files: takes('sfx_env_rain_loop', 1), bus: 'ambient', loop: true, gain: 0.24, fadeIn: 1.2 },
	env_storm_thunder: { files: takes('sfx_env_storm_thunder', 3), bus: 'ambient', gain: 0.42, jitter: [0.94, 1.06] },
