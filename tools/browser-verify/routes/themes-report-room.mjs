/**
 * THE REPORT BOX WITH NO ROOM HOOK (report 35, 2026-09-25). The control case: no room hook and no site theme, so every value is the fallback it always was.
 *
...
export default {
	path: '/dev/themes?report=room',
	label: 'IDEA default: the report box on the portal tokens, with no room hook',
	prepare: [OPEN_REPORT_BOX, TYPE_REPORT, ROOM_INKS],
	presence: [
		{ selector: 'html:not([data-theme])', label: 'the site theme this spec is about (positive control)', expectPresent: 1, maxPresent: 1 },
