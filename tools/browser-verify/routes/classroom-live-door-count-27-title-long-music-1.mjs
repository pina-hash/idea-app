 ...
 * the music tool and the door sharing one class-tools row, with 27 student(s)
 ...
 */
export default {
	path: '/dev/classroom-live-door?count=27&title=long&music=1',
	label: 'Class page: the Live door with 27 on a long-titled assignment, three tools in the row',
