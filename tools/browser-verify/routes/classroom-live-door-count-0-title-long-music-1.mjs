 ...
 * the music tool and the door sharing one class-tools row, with 0 student(s)
 ...
 */
export default {
	path: '/dev/classroom-live-door?count=0&title=long&music=1',
	label: 'Class page: the Live door with 0 on a long-titled assignment, three tools in the row',
	prepare: [doorReady(0), { evaluate: DOOR_GEOMETRY }],
	orderResult: [
		{ label: 'the count holds together and only the title gives', evaluate: doorVerdicts(0), expected: doorExpected(0) },
