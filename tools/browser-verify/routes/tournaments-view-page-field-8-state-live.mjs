export default {
	path: '/dev/tournaments?view=page&field=8&state=live',
	label: 'The event page composition in the room, 8 entries, one match live',
	/* The public page's pieces in the room the layout chain gives every
	   ...
	   event rail, the bracket at 8 entries, a card with body copy, dim copy
