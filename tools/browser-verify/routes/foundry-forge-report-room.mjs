/**
 * THE REPORT BOX IN THIS ROOM'S COLOURS (report 35, 2026-09-25). In the Foundry it is the forge plate, with no heat on it.
 *
...
export default {
	path: '/dev/foundry-forge?report=room',
	label: 'Foundry: the report box and its control on the forge plate',
	prepare: [OPEN_REPORT_BOX, TYPE_REPORT, ROOM_INKS],
	presence: [
		{ selector: '.fg-root', label: 'the room wrapper (positive control: the hooks key on it)', expectPresent: 1 },
