/**
 * THE REPORT BOX IN THIS ROOM'S COLOURS (report 35, 2026-09-25). On FRC it is the paper palette with FIRST blue as the accent, never IDEA green (achievement-only there), whatever site theme is stored: /frc is outside Space White by design.
 *
...
export default {
	path: '/dev/frc?report=room',
	label: 'FRC: the report box and its control in the FRC paper palette, FIRST blue accent',
	prepare: [OPEN_REPORT_BOX, TYPE_REPORT, ROOM_INKS],
	presence: [
		{ selector: '.frc-root', label: 'the room wrapper (positive control: the hooks key on it)', expectPresent: 1 },
