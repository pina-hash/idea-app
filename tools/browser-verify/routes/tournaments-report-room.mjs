/**
 * THE REPORT BOX IN THIS ROOM'S COLOURS (report 35, 2026-09-25). In Tournaments it is the room plate, with no emerald spent on it.
 *
...
export default {
	path: '/dev/tournaments?report=room',
	label: 'Tournaments: the report box and its control on the room plate, no emerald',
	prepare: [OPEN_REPORT_BOX, TYPE_REPORT, ROOM_INKS],
	presence: [
		{ selector: '.tnm-root', label: 'the room wrapper (positive control: the hooks key on it)', expectPresent: 1 },
