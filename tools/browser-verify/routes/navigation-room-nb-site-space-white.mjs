...
export default {
	path: '/dev/navigation-room-nb?site=space-white',
	label: 'The pending primitive in the notebook room under Space White (.nb-root in .cr-root)',
	widths: WIDTHS,
	/*
		...
		readings are three routes: this one, and its siblings under the default and matrix.
		`contrast` reports the worst match, and with one room per page nothing
		collapses two grounds into one number.
	*/
	prepare: [
		{ waitFor: '() => document.documentElement.getAttribute("data-theme") === "space-white"', timeoutMs: 5_000 }
	],
	presence: [
		{ selector: '[data-testid="nb-room"].nb-root[data-site="space-white"]', label: 'the notebook room, under Space White', expectPresent: 1, maxPresent: 1, expectVisible: 1, maxVisible: 1 },
	...
	contrast: [
		{ selector: '.nb-root .card .pending', label: 'pending label, Space White', min: 4.5 }
	]
};
