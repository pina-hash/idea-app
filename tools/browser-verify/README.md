...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 119 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 238 |

<!-- counts:static:data {"schema":1,"specs":119,"routes":58,"devPages":87,"widths":[375,1440],"runs":238} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-06T09:02:34.883Z on commit `83011f7` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 119 |
| Route/width runs the report carried | 238 |
| Measurements | 3472 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 573.5s |
