...
| Distinct routes those specs drive (alias-resolved, query string stripped) | 92 |
| Directories under `src/routes/dev` with a page (the candidate set) | 119 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 474 |

<!-- counts:static:data {"schema":1,"specs":237,"routes":92,"devPages":119,"widths":[375,1440],"runs":474} -->
<!-- counts:static:end -->
...
| Wall clock, summed from each spec's attributed share | 1334.5s |
