...
<!-- counts:measured:data {"schema":1,"date":"2026-09-05T14:57:18.747Z","sha":"ada9041392739738d21e52f1a8d49c4eacd3e6fc","dirty":false,"runsMeasured":202,"measurements":2910,"outside":2,"outsideRows":[{"path":"/dev/spec-table?empty=1","width":375,"check":"tap-target","label":"row action glyphs (known finding)"},{"path":"/dev/spec-table?empty=1","width":1440,"check":"tap-target","label":"row action glyphs (known finding)"}],"totalMs":473290,"selftest":{"controls":70,"negative":36,"positive":34,"failures":0}} -->
<!-- counts:measured:end -->
