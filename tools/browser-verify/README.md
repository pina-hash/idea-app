...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-03T00:12:19.159Z on commit `a39e99b` by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.

| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 70 |
...
| Widths | 2 (375, 1440) |
| Route/width runs (specs x widths) | 140 |
| Route/width runs the report carried | 140 |
| Measurements | 1878 |
| Measurements outside threshold | 4 |
| Full-run wall clock | 335.4s |
...
<!-- counts:data {"schema":1,"date":"2026-09-03T00:12:19.159Z","sha":"a39e99bd5807a0d1ce36cde07a220057e69bf396","dirty":false,"specs":70,"routes":38,"devPages":70,"widths":[375,1440],"runs":140,"runsMeasured":140,"measurements":1878,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":335383,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:end -->
