...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-11T10:11:49.525Z on commit `e547515` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 189 |
| Route/width runs the report carried | 378 |
| Measurements | 6598 |
