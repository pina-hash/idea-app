...
| Distinct routes those specs drive (alias-resolved, query string stripped) | 77 |
| Directories under `src/routes/dev` with a page (the candidate set) | 105 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 380 |

<!-- counts:static:data {"schema":1,"specs":190,"routes":77,"devPages":105,"widths":[375,1440],"runs":380} -->
<!-- counts:static:end -->
