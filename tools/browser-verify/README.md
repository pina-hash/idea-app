...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-05T18:53:04.266Z on commit `e901dbd` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 106 |
| Route/width runs the report carried | 212 |
| Measurements | 3100 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 507.7s |
