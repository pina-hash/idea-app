...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-03T19:12:51.886Z on commit `2b09ab1` by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.
...
| Widths | 2 (375, 1440) |
| Route/width runs (specs x widths) | 172 |
| Route/width runs the report carried | 172 |
| Measurements | 2390 |
| Measurements outside threshold | 8 |
| Full-run wall clock | 416.5s |
