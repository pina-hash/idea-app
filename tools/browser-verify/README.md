...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-05T14:43:57.313Z on commit `9e09d36` (working tree dirty at measurement) by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state and says which commit it was taken on.
...
| Full-run wall clock | 453.4s |
| `--selftest` controls | 70 (36 negative, 34 positive), 0 instrument failure(s) |

No measurement was outside its threshold on that run.

<!-- counts:measured:data {"schema":1,"date":"2026-09-05T14:43:57.313Z","sha":"9e09d36c371b23bd76c41742be786d1960dae826","dirty":true,"runsMeasured":198,"measurements":2846,"outside":0,"outsideRows":[],"totalMs":453446,"selftest":{"controls":70,"negative":36,"positive":34,"failures":0}} -->
<!-- counts:measured:end -->
