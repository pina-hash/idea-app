...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 88 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 176 |

<!-- counts:static:data {"schema":1,"specs":88,"routes":44,"devPages":76,"widths":[375,1440],"runs":176} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-03T23:37:48.554Z on commit `e1b2807` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state and says which commit it was taken on.

| Count | Value |
| --- | --- |
| Route/width runs the report carried | 174 |
| Measurements | 2408 |
| Measurements outside threshold | 4 |
| Full-run wall clock | 414.6s |
...
<!-- counts:measured:data {"schema":1,"date":"2026-09-03T23:37:48.554Z","sha":"e1b2807f0e5f3ec863c94f4986aa600d3dcf85c9","dirty":false,"runsMeasured":174,"measurements":2408,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":414603,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:measured:end -->
