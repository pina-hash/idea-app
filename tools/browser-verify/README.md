...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 261 |
| Route/width runs those measurements cover | 522 |
| Measurements | 9498 |
| Measurements outside threshold | 182 |
| Wall clock, summed from each spec's attributed share | 1458.8s |
