...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 239 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 478 |

<!-- counts:static:data {"schema":1,"specs":239,"routes":93,"devPages":119,"widths":[375,1440],"runs":478} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 239 |
| Route/width runs those measurements cover | 478 |
| Measurements | 8692 |
| Measurements outside threshold | 146 |
| Wall clock, summed from each spec's attributed share | 1345.1s |
