...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 197 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 394 |

<!-- counts:static:data {"schema":1,"specs":197,"routes":81,"devPages":109,"widths":[375,1440],"runs":394} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 197 |
| Route/width runs those measurements cover | 394 |
| Measurements | 6898 |
| Measurements outside threshold | 0 |
| Wall clock, summed from each spec's attributed share | 1065.9s |
