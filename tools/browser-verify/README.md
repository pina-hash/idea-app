...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 94 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 47 |
| Directories under `src/routes/dev` with a page (the candidate set) | 78 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 188 |

<!-- counts:static:data {"schema":1,"specs":94,"routes":47,"devPages":78,"widths":[375,1440],"runs":188} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-04T01:22:54.783Z on commit `152b84d` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state and says which commit it was taken on.

| Count | Value |
| --- | --- |
| Route/width runs the report carried | 188 |
| Measurements | 2622 |
| Measurements outside threshold | 0 |
| Full-run wall clock | 434.3s |
| `--selftest` controls | 64 (32 negative, 32 positive), 0 instrument failure(s) |

No measurement was outside its threshold on that run.

<!-- counts:measured:data {"schema":1,"date":"2026-09-04T01:22:54.783Z","sha":"152b84df6934a598b10949d812cd463e0caf7d83","dirty":false,"runsMeasured":188,"measurements":2622,"outside":0,"outsideRows":[],"totalMs":434349,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:measured:end -->
