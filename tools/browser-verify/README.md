...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 295 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 104 |
| Directories under `src/routes/dev` with a page (the candidate set) | 132 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 590 |

<!-- counts:static:data {"schema":1,"specs":295,"routes":104,"devPages":132,"widths":[375,1440],"runs":590} -->
<!-- counts:static:end -->
