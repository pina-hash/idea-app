...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 353 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 114 |
| Directories under `src/routes/dev` with a page (the candidate set) | 143 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 706 |

<!-- counts:static:data {"schema":1,"specs":353,"routes":114,"devPages":143,"widths":[375,1440],"runs":706} -->
<!-- counts:static:end -->
