...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-02T10:20:01.427Z on commit `6841f4e` by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.

| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 66 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 37 |
| Directories under `src/routes/dev` with a page (the candidate set) | 69 |
| Widths | 2 (375, 1440) |
| Route/width runs (specs x widths) | 132 |
| Route/width runs the report carried | 132 |
| Measurements | 1738 |
| Measurements outside threshold | 4 |
| Full-run wall clock | 304.3s |
...
<!-- counts:data {"schema":1,"date":"2026-09-02T10:20:01.427Z","sha":"6841f4ec2f472c0259500aa25f81549e2837e07e","dirty":false,"specs":66,"routes":37,"devPages":69,"widths":[375,1440],"runs":132,"runsMeasured":132,"measurements":1738,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":304261,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:end -->
