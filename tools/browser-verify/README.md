...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-03T00:32:41.829Z on commit `f6691db` by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.
...
<!-- counts:data {"schema":1,"date":"2026-09-03T00:32:41.829Z","sha":"f6691db48768311bf6e56dbe7b484873033b840f","dirty":false,"specs":69,"routes":38,"devPages":70,"widths":[375,1440],"runs":138,"runsMeasured":138,"measurements":1832,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":325071,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:end -->
