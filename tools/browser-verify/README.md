...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 178 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 356 |

<!-- counts:static:data {"schema":1,"specs":178,"routes":71,"devPages":98,"widths":[375,1440],"runs":356} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-10T04:07:27.652Z on commit `007d896` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
