...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 196 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 392 |

<!-- counts:static:data {"schema":1,"specs":196,"routes":80,"devPages":108,"widths":[375,1440],"runs":392} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-11T18:32:29.615Z on commit `51a1c98` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
