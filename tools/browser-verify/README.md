...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 246 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 492 |

<!-- counts:static:data {"schema":1,"specs":246,"routes":95,"devPages":121,"widths":[375,1440],"runs":492} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 246 |
| Route/width runs those measurements cover | 492 |
| Measurements | 8988 |
| Measurements outside threshold | 146 |
| Wall clock, summed from each spec's attributed share | 1414.9s |
