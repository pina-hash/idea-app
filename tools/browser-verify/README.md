...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 134 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 268 |

<!-- counts:static:data {"schema":1,"specs":134,"routes":64,"devPages":92,"widths":[375,1440],"runs":268} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-06T21:09:40.302Z on commit `79a9faa` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
