...
<!-- counts:measured:data {"schema":1,"date":"2026-09-05T14:57:24.985Z","sha":"3f4ccaf64fcb9ca2c30a8a891b4bfda7dc06abd5","dirty":false,"runsMeasured":198,"measurements":2870,"outside":2,"outsideRows":[{"path":"/dev/spec-table?empty=1","width":375,"check":"tap-target","label":"row action glyphs (known finding)"},{"path":"/dev/spec-table?empty=1","width":1440,"check":"tap-target","label":"row action glyphs (known finding)"}],"totalMs":465693,"selftest":{"controls":70,"negative":36,"positive":34,"failures":0}} -->
<!-- counts:measured:end -->
