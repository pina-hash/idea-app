...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 140 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 280 |

<!-- counts:static:data {"schema":1,"specs":140,"routes":66,"devPages":94,"widths":[375,1440],"runs":280} -->
<!-- counts:static:end -->
