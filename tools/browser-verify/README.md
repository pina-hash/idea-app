...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-06T22:37:55.100Z on commit `73d762a` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 138 |
| Route/width runs the report carried | 276 |
| Measurements | 4218 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 659.0s |
