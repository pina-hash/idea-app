...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 404 |
| Route/width runs those measurements cover | 808 |
| Measurements | 13500 |
| Measurements outside threshold | 211 |
| Wall clock, summed from each spec's attributed share | 2482.4s |
