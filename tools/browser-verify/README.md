...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 144 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 288 |

<!-- counts:static:data {"schema":1,"specs":144,"routes":67,"devPages":95,"widths":[375,1440],"runs":288} -->
<!-- counts:static:end -->
