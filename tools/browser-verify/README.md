...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 147 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 294 |

<!-- counts:static:data {"schema":1,"specs":147,"routes":67,"devPages":95,"widths":[375,1440],"runs":294} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-09T12:28:55.760Z on commit `da4605b` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 145 |
| Route/width runs the report carried | 290 |
| Measurements | 4454 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 695.5s |
