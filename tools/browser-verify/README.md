...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 190 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 380 |

<!-- counts:static:data {"schema":1,"specs":190,"routes":76,"devPages":104,"widths":[375,1440],"runs":380} -->
<!-- counts:static:end -->
