...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 201 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 402 |

<!-- counts:static:data {"schema":1,"specs":201,"routes":81,"devPages":109,"widths":[375,1440],"runs":402} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 201 |
| Route/width runs those measurements cover | 402 |
| Measurements | 7126 |
| Measurements outside threshold | 0 |
| Wall clock, summed from each spec's attributed share | 1102.0s |
