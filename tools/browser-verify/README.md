...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 244 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 488 |

<!-- counts:static:data {"schema":1,"specs":244,"routes":93,"devPages":119,"widths":[375,1440],"runs":488} -->
<!-- counts:static:end -->
