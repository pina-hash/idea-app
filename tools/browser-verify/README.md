...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 248 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 496 |

<!-- counts:static:data {"schema":1,"specs":248,"routes":95,"devPages":121,"widths":[375,1440],"runs":496} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 248 |
| Route/width runs those measurements cover | 496 |
| Measurements | 9072 |
| Measurements outside threshold | 182 |
| Wall clock, summed from each spec's attributed share | 1338.5s |
