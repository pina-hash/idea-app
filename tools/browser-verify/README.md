...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-02T12:04:03.697Z on commit `ca37ea6` by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.

| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 67 |
...
| Widths | 2 (375, 1440) |
| Route/width runs (specs x widths) | 134 |
| Route/width runs the report carried | 134 |
| Measurements | 1788 |
| Measurements outside threshold | 6 |
| Full-run wall clock | 348.7s |
...
<!-- counts:data {"schema":1,"date":"2026-09-02T12:04:03.697Z","sha":"ca37ea6d8cf074040d291b85c034a0b07042733d","dirty":false,"specs":67,"routes":38,"devPages":70,"widths":[375,1440],"runs":134,"runsMeasured":134,"measurements":1788,"outside":6,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/notebook","width":375,"check":"presence","label":"free-entry title + folder fields (both stacked, not row-flex)"},{"path":"/dev/gauntlet-shell-countdown","width":1440,"check":"presence","label":"the numeral currently on screen"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":348653,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:end -->
