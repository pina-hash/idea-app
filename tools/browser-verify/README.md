...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-02T11:52:33.460Z on commit `0adca96` (working tree dirty at measurement) by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.
...
<!-- counts:data {"schema":1,"date":"2026-09-02T11:52:33.460Z","sha":"0adca96c7d82c76ba0a6d561670779c812789e80","dirty":true,"specs":67,"routes":38,"devPages":70,"widths":[375,1440],"runs":134,"runsMeasured":134,"measurements":1788,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":344944,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:end -->
