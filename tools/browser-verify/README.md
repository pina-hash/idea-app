...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 179 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 72 |
| Directories under `src/routes/dev` with a page (the candidate set) | 100 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 358 |

<!-- counts:static:data {"schema":1,"specs":179,"routes":72,"devPages":100,"widths":[375,1440],"runs":358} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-10T05:54:02.006Z on commit `82ea7e2` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
