...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 121 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 60 |
| Directories under `src/routes/dev` with a page (the candidate set) | 89 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 242 |

<!-- counts:static:data {"schema":1,"specs":121,"routes":60,"devPages":89,"widths":[375,1440],"runs":242} -->
<!-- counts:static:end -->
