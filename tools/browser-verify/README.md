...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-03T22:40:03.454Z on commit `54154bd` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state and says which commit it was taken on.

| Count | Value |
| --- | --- |
| Route/width runs the report carried | 168 |
| Measurements | 2336 |
| Measurements outside threshold | 4 |
| Full-run wall clock | 391.3s |
...
<!-- counts:measured:data {"schema":1,"date":"2026-09-03T22:40:03.454Z","sha":"54154bdc87a8ef03673f3bf0e780c000446de4ef","dirty":false,"runsMeasured":168,"measurements":2336,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":391334,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:measured:end -->
