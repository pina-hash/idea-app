...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 145 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 290 |

<!-- counts:static:data {"schema":1,"specs":145,"routes":67,"devPages":95,"widths":[375,1440],"runs":290} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-09T10:27:22.324Z on commit `3c7f7c7` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 144 |
| Route/width runs the report carried | 288 |
| Measurements | 4396 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 694.2s |
