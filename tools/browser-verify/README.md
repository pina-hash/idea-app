...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-05T19:53:16.572Z on commit `4ecf48f` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 107 |
| Route/width runs the report carried | 214 |
| Measurements | 3142 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 493.3s |
