...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-09T12:47:32.035Z on commit `277e76a` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 147 |
| Route/width runs the report carried | 294 |
| Measurements | 4560 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 766.6s |
