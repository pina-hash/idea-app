...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 103 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 206 |

<!-- counts:static:data {"schema":1,"specs":103,"routes":52,"devPages":82,"widths":[375,1440],"runs":206} -->
<!-- counts:static:end -->
