...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 270 |
| Route/width runs those measurements cover | 540 |
| Measurements | 9806 |
| Measurements outside threshold | 182 |
| Wall clock, summed from each spec's attributed share | 1550.4s |
