...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 273 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 546 |

<!-- counts:static:data {"schema":1,"specs":273,"routes":100,"devPages":126,"widths":[375,1440],"runs":546} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 273 |
| Route/width runs those measurements cover | 546 |
| Measurements | 9912 |
| Measurements outside threshold | 182 |
| Wall clock, summed from each spec's attributed share | 1587.5s |
