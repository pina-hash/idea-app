...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 206 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 412 |

<!-- counts:static:data {"schema":1,"specs":206,"routes":82,"devPages":110,"widths":[375,1440],"runs":412} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 206 |
| Route/width runs those measurements cover | 412 |
| Measurements | 7342 |
| Measurements outside threshold | 0 |
| Wall clock, summed from each spec's attributed share | 1123.5s |
