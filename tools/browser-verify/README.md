...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-09T15:13:20.541Z on commit `18b1d33` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 156 |
| Route/width runs the report carried | 312 |
| Measurements | 5238 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 796.0s |
