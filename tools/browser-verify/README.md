...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 431 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 862 |

<!-- counts:static:data {"schema":1,"specs":431,"routes":127,"devPages":155,"widths":[375,1440],"runs":862} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 431 |
| Route/width runs those measurements cover | 862 |
| Measurements | 14586 |
| Measurements outside threshold | 211 |
| Wall clock, summed from each spec's attributed share | 2739.3s |
