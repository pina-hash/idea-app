...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 271 |
| Route/width runs those measurements cover | 542 |
| Measurements | 9846 |
| Measurements outside threshold | 182 |
| Wall clock, summed from each spec's attributed share | 1570.4s |
