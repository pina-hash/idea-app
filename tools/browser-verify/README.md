...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 95 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 48 |
| Directories under `src/routes/dev` with a page (the candidate set) | 79 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 190 |

<!-- counts:static:data {"schema":1,"specs":95,"routes":48,"devPages":79,"widths":[375,1440],"runs":190} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-04T04:20:59.578Z on commit `3a46b95` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state and says which commit it was taken on.

| Count | Value |
| --- | --- |
| Route/width runs the report carried | 190 |
| Measurements | 2662 |
| Measurements outside threshold | 0 |
| Full-run wall clock | 448.2s |
| `--selftest` controls | 70 (36 negative, 34 positive), 0 instrument failure(s) |

No measurement was outside its threshold on that run.

<!-- counts:measured:data {"schema":1,"date":"2026-09-04T04:20:59.578Z","sha":"3a46b954eff9f76fb4b504d2973a54b3934c58bf","dirty":false,"runsMeasured":190,"measurements":2662,"outside":0,"outsideRows":[],"totalMs":448201,"selftest":{"controls":70,"negative":36,"positive":34,"failures":0}} -->
<!-- counts:measured:end -->
