...
| Directories under `src/routes/dev` with a page (the candidate set) | 77 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 174 |

<!-- counts:static:data {"schema":1,"specs":87,"routes":45,"devPages":77,"widths":[375,1440],"runs":174} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-04T00:07:34.473Z on commit `0d42c70` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state and says which commit it was taken on.
...
<!-- counts:measured:data {"schema":1,"date":"2026-09-04T00:07:34.473Z","sha":"0d42c70b89b518bd6e2e8786bec952816f49546c","dirty":false,"runsMeasured":174,"measurements":2412,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":396642,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:measured:end -->
