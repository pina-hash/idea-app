...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 97 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 194 |

<!-- counts:static:data {"schema":1,"specs":97,"routes":50,"devPages":81,"widths":[375,1440],"runs":194} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-05T01:56:59.269Z on commit `5d587bb` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state and says which commit it was taken on.

| Count | Value |
| --- | --- |
| Route/width runs the report carried | 194 |
| Measurements | 2776 |
| Measurements outside threshold | 0 |
| Full-run wall clock | 439.3s |
| `--selftest` controls | 70 (36 negative, 34 positive), 0 instrument failure(s) |

No measurement was outside its threshold on that run.

<!-- counts:measured:data {"schema":1,"date":"2026-09-05T01:56:59.269Z","sha":"5d587bbb395a6796d5047b40d65cd32daeab4eeb","dirty":false,"runsMeasured":194,"measurements":2776,"outside":0,"outsideRows":[],"totalMs":439317,"selftest":{"controls":70,"negative":36,"positive":34,"failures":0}} -->
<!-- counts:measured:end -->
