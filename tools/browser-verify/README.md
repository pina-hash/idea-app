...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 313 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 108 |
| Directories under `src/routes/dev` with a page (the candidate set) | 137 |
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 626 |

<!-- counts:static:data {"schema":1,"specs":313,"routes":108,"devPages":137,"widths":[375,1440],"runs":626} -->
<!-- counts:static:end -->
