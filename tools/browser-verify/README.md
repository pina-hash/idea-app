...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 222 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 444 |

<!-- counts:static:data {"schema":1,"specs":222,"routes":86,"devPages":114,"widths":[375,1440],"runs":444} -->
<!-- counts:static:end -->
...
| Count | Value |
| --- | --- |
| Route specs measured (one file each under `measured/`) | 222 |
| Route/width runs those measurements cover | 444 |
| Measurements | 7940 |
| Measurements outside threshold | 0 |
| Wall clock, summed from each spec's attributed share | 1234.0s |
