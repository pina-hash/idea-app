...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-05T20:19:28.116Z on commit `f43e589` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 113 |
| Route/width runs the report carried | 226 |
| Measurements | 3300 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 566.1s |
