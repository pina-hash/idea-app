...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-10T03:24:34.123Z on commit `a8fa260` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 164 |
| Route/width runs the report carried | 328 |
| Measurements | 5622 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 836.0s |
