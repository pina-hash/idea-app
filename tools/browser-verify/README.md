...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 185 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 370 |

<!-- counts:static:data {"schema":1,"specs":185,"routes":75,"devPages":103,"widths":[375,1440],"runs":370} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-11T05:55:41.661Z on commit `e508157` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
