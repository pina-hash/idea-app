...
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-06T09:00:57.839Z on commit `be91dde` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 124 |
| Route/width runs the report carried | 248 |
| Measurements | 3668 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 587.3s |
