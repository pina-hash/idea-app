...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-02T08:53:44.592Z on commit `56b3bcd` (working tree dirty at measurement) by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.

| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 65 |
| Distinct routes those specs drive (alias-resolved, query string stripped) | 36 |
| Directories under `src/routes/dev` with a page (the candidate set) | 69 |
| Widths | 2 (375, 1440) |
| Route/width runs (specs x widths) | 130 |
| Route/width runs the report carried | 130 |
| Measurements | 1710 |
| Measurements outside threshold | 4 |
| Full-run wall clock | 312.8s |
...
<!-- counts:data {"schema":1,"date":"2026-09-02T08:53:44.592Z","sha":"56b3bcddb8521376b14ce182fd87f1d6ca0e0e31","dirty":true,"specs":65,"routes":36,"devPages":69,"widths":[375,1440],"runs":130,"runsMeasured":130,"measurements":1710,"outside":4,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":312806,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:end -->
