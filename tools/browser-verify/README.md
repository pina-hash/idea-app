...
<!-- counts:measured:data {"schema":1,"date":"2026-09-05T01:48:14.110Z","sha":"700a56d895a113dc231226048a999c591f18c635","dirty":false,"runsMeasured":196,"measurements":2744,"outside":2,"outsideRows":[{"path":"/dev/spec-table?empty=1","width":375,"check":"tap-target","label":"row action glyphs (known finding)"},{"path":"/dev/spec-table?empty=1","width":1440,"check":"tap-target","label":"row action glyphs (known finding)"}],"totalMs":459253,"selftest":{"controls":70,"negative":36,"positive":34,"failures":0}} -->
<!-- counts:measured:end -->
