...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 143 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 286 |

<!-- counts:static:data {"schema":1,"specs":143,"routes":66,"devPages":94,"widths":[375,1440],"runs":286} -->
<!-- counts:static:end -->

### Measured -- from a full harness run

<!-- counts:measured:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-07T11:48:33.045Z on commit `b7046a8` by a full run of `tools/browser-verify/run.mjs` in this container. It needs a browser and about six minutes, so it is regenerated deliberately and not on every branch; a stale-but-honest measured half is a supported state.
...
| Count | Value |
| --- | --- |
| Route specs the run covered | 142 |
| Route/width runs the report carried | 284 |
| Measurements | 4340 |
| Measurements outside threshold | 2 |
| Full-run wall clock | 724.0s |
