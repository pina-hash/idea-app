...
| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 101 |
...
| Widths | 2 (375, 1440) |
| Route/width runs a full pass makes (specs x widths) | 202 |

<!-- counts:static:data {"schema":1,"specs":101,"routes":51,"devPages":82,"widths":[375,1440],"runs":202} -->
<!-- counts:static:end -->
