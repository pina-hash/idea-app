...
<!-- counts:begin -->
**Generated by `npm run verify:readme`; do not edit by hand.** Measured 2026-09-02T15:54:45.780Z on commit `8dfc4e8` (working tree dirty at measurement) by a full run of `tools/browser-verify/run.mjs` in this container. `tests/derived-numbers.test.ts` reddens on a hand edit or on a spec added without regenerating.

| Count | Value |
| --- | --- |
| Route specs (`routes/*.mjs`, `_`-prefixed excluded) | 69 |
...
| Widths | 2 (375, 1440) |
| Route/width runs (specs x widths) | 138 |
| Route/width runs the report carried | 138 |
| Measurements | 1820 |
| Measurements outside threshold | 6 |
| Full-run wall clock | 355.6s |
...
- `/dev/notebook` @375 `presence` free-entry title + folder fields (both stacked, not row-flex)
- `/dev/gauntlet-shell-countdown` @1440 `presence` the numeral currently on screen
- `/dev/coins-signedin-1` @375 `horizontal-scroll`
- `/dev/coins` @375 `horizontal-scroll`

<!-- counts:data {"schema":1,"date":"2026-09-02T15:54:45.780Z","sha":"8dfc4e87cd0114f9327d43f369fc83e10cd5928d","dirty":true,"specs":69,"routes":38,"devPages":70,"widths":[375,1440],"runs":138,"runsMeasured":138,"measurements":1820,"outside":6,"outsideRows":[{"path":"/dev/pathways","width":375,"check":"tap-target","label":"harness controls"},{"path":"/dev/pathways","width":1440,"check":"tap-target","label":"harness controls"},{"path":"/dev/notebook","width":375,"check":"presence","label":"free-entry title + folder fields (both stacked, not row-flex)"},{"path":"/dev/gauntlet-shell-countdown","width":1440,"check":"presence","label":"the numeral currently on screen"},{"path":"/dev/coins-signedin-1","width":375,"check":"horizontal-scroll","label":""},{"path":"/dev/coins","width":375,"check":"horizontal-scroll","label":""}],"totalMs":355585,"selftest":{"controls":64,"negative":32,"positive":32,"failures":0}} -->
<!-- counts:end -->
